...
int main(void) {
  ...
  while(loop){
    ...
    PWM_SetDC(2,getSpeed(2));//PE11 | PC 7
    PWM_SetDC(3,getSpeed(3));//PE13
    PWM_SetDC(4,getSpeed(4));//PE14
      ...
      if(cnt == 5){
        if(received_string[cnt-5]=='L'){
          if(received_string[cnt-4]=='X'){
            lx = 100*(received_string[cnt-3]-48)+10*(received_string[cnt-2]-48)+received_string[cnt-1]-48;
          }else if(received_string[cnt-4]=='Y'){
            ly = 100*(received_string[cnt-3]-48)+10*(received_string[cnt-2]-48)+received_string[cnt-1]-48;
          }
        }else if(received_string[cnt-5]=='R'){
          if(received_string[cnt-4]=='X'){
            rx = 100*(received_string[cnt-3]-48)+10*(received_string[cnt-2]-48)+received_string[cnt-1]-48;
          }else if(received_string[cnt-4]=='Y'){
            ry = 100*(received_string[cnt-3]-48)+10*(received_string[cnt-2]-48)+received_string[cnt-1]-48;
          }
        }
      }else if((received_string[cnt-1]=0x53) && (cnt == 17)){
          //End of motor correction
          motorCor[0] = 10*(received_string[cnt-15]-48)+received_string[cnt-14]-48;
          motorCor[1] = 10*(received_string[cnt-11]-48)+received_string[cnt-10]-48;
          motorCor[2] = 10*(received_string[cnt-7]-48)+received_string[cnt-6]-48;
          motorCor[3] = +10*(received_string[cnt-3]-48)+received_string[cnt-2]-48;
          if(received_string[cnt-16]==0x4E)motorCor[0]*=-1;
          if(received_string[cnt-12]==0x4E)motorCor[1]*=-1;
          if(received_string[cnt-8]==0x4E)motorCor[2]*=-1;
          if(received_string[cnt-4]==0x4E)motorCor[3]*=-1;
    }else if(received_string[cnt-1]=='C' && t == '1')sendPosition = 1;
      else if(received_string[cnt-1]=='C' && t == '0')sendPosition = 0;
      cnt = 0;
    }
